...
class ZhuaquSpider():
    ...
    def parse_html(self):
        ...
        # 无头模式
        browser = webdriver.Chrome(executable_path=r'C:\Users\Administrator\AppData\Local\Programs\Python\Python38-32\Scripts\chromedriver.exe')
        ...
        time.sleep(3)
        #手机管理定位
        #//*[@id="aside"]/div[1]/div/ul/li[3]/div/span
        browser.find_element_by_xpath('//*[@id="aside"]/div[1]/div/ul/li[3]/div/span').click()
        time.sleep(1)
        #通话数据定位
        #//*[@id="aside"]/div[1]/div/ul/li[3]/ul/li/ul/li/span
        browser.find_element_by_xpath('//*[@id="aside"]/div[1]/div/ul/li[3]/ul/li/ul/li/span').click()
